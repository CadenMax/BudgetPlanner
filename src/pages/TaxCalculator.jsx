    ...
    <div className="grid gap-6 lg:grid-cols-[1fr_1fr]">
      ...
      <div className="flex flex-col gap-5">
        <div className="glass rounded-2xl p-6 flex flex-col gap-5 fade-up">
          <h2 className="text-xs font-semibold uppercase tracking-widest text-gray-500">Your Details</h2>
        ...
        <div className="rounded-2xl overflow-hidden fade-up fade-up-1" style={{
          ...
          <div className="px-6 pt-6 pb-4 border-b border-white/5">
            <div className="text-xs uppercase tracking-widest text-gray-500 mb-1">Weekly Gross</div>
            <div className="mono text-4xl font-bold text-white">{formatMoney(model.grossIncome)}</div>
          </div>
          <div className="grid grid-cols-2 divide-x divide-white/5">
            <div className="px-6 py-4">
              <div className="text-xs uppercase tracking-widest text-gray-500 mb-1">PAYG Withheld</div>
            ...
            <div className="px-6 py-4">
              <div className="text-xs uppercase tracking-widest text-gray-500 mb-1">Net Pay</div>
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="glass rounded-2xl p-6 fade-up fade-up-2">
          <h2 className="text-xs font-semibold uppercase tracking-widest text-gray-500 mb-3">Calculation Method</h2>
        ...
        <div className="rounded-2xl p-5 fade-up fade-up-3" style={{
          ...
          <p className="text-sm text-orange-200/60 leading-relaxed">
            Weekly tax table applies from 1 July 2024 and continues after the 24 September 2025 update.
          </p>
        </div>

        {/* Annualised */}
        <div className="glass rounded-2xl p-6 fade-up fade-up-4">
          <h2 className="text-xs font-semibold uppercase tracking-widest text-gray-500 mb-4">Annualised Estimates</h2>
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              <div key={label} className="rounded-xl p-3 text-center" style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.06)" }}>
                ...
                <div className="text-xs text-gray-700 mt-0.5">/ yr</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="glass rounded-2xl p-6 fade-up fade-up-5">
          <h2 className="text-xs font-semibold uppercase tracking-widest text-gray-500 mb-4">Per Period Breakdown</h2>
            ...
            {[
              ...
              <div key={period} className="flex justify-between items-center py-2 border-b border-white/5 last:border-0">
                ...
                <div className="flex gap-6 text-right">
                  <div>
                    <div className="text-xs text-gray-700">Gross</div>
                    <div className="mono text-sm text-gray-300">{formatMoney(model.grossIncome * factor)}</div>
                  </div>
                  <div>
