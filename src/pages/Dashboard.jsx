    ...
    <div className="grid gap-8">
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_1.4fr]">
        ...
        <div className="glass rounded-2xl p-6 flex flex-col gap-5 fade-up">
          <h2 className="text-xs font-semibold uppercase tracking-widest ">Income Inputs</h2>
        ...
        <div className="flex flex-col gap-4">
          <h2 className="text-xs font-semibold uppercase tracking-widest fade-up">Income Summary</h2>
          ...
          <div className="glass rounded-2xl p-4 fade-up fade-up-4">
            <div className="text-xs font-semibold uppercase tracking-widest mb-3">50 / 30 / 20 Split</div>
            ...
            <div className="flex justify-between mt-2 text-xs text-white-600">
      ...
      <div>
        <h2 className="text-xs font-semibold uppercase tracking-widest mb-4 fade-up">Budget Allocations</h2>
      ...
      {/* Remaining — 3 col */}
      <div>
        <h2 className="text-xs font-semibold uppercase tracking-widest text-white-0 mb-4 fade-up">Remaining After Expenses</h2>
        <div className="grid gap-4 sm:grid-cols-3">
      ...
      {/* Freed capital — 2 col */}
      <div>
        <h2 className="text-xs font-semibold uppercase tracking-widest  mb-4 fade-up">Freed Capital</h2>
      ...
      <div className="grid gap-6">
        <h2 className="text-xs font-semibold uppercase tracking-widest  fade-up">Budget Breakdown</h2>
